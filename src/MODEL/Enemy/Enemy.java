...
public abstract class Enemy extends Observable implements Entity {
    ...
    /**
     * Metodo per gestire l'azione di attacco del nemico (cambia direzione e avvia il timer di attacco).
     */
    public void stop(){
    ...
    /**
     * Metodo per gestire l'azione di morte del nemico (ferma il timer di attacco e rimuove il nemico).
     */
    void die(){
    }
